  ...
  return (
    ...
    <div className='w-full inline-block'>
      <article className='flex flex-col items-start justify-end mx-10 relative h-[85vh]'>
        ...
        <div className="w-full h-1/3 flex flex-col items-center justify-center text-light z-40">

          <form onSubmit={handleSubmit(onSubmit)} className="w-1/2 flex items-stretch bg-light/90 p-2 border-black border-2 rounded-full hover:bg-light">
            <input
            type="text" 
